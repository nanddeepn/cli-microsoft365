...
- added [sample script](../sample-scripts/spo/list-tenant-alert-usage/index.mdx) to list all deprecated SharePoint list alerts across the tenant [#6864](https://github.com/pnp/cli-microsoft365/issues/6864)
- enhanced SPFx commands to set a description for application customizers and ListView Command Sets [#6706](https://github.com/pnp/cli-microsoft365/issues/6706)
- added minimal permissions for 'entra groupsettingtemplate' commands [#6938](https://github.com/pnp/cli-microsoft365/issues/6938)
- added support for SPFx v1.22.0-rc.0 [#6974](https://github.com/pnp/cli-microsoft365/issues/6974)
- fixed 'teams channel add' using app permissions [#7045](https://github.com/pnp/cli-microsoft365/issues/7045)
